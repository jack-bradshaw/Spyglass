...
import static com.matthewtamlin.spyglass.processors.code_generation.CallerComponents.getGetDefaultValueSpecFor;
import static com.matthewtamlin.spyglass.processors.code_generation.CallerComponents.getGetValueSpecFor;
import static com.matthewtamlin.spyglass.processors.code_generation.CallerComponents.getShouldCallMethodSpecFor;
import static com.matthewtamlin.spyglass.processors.code_generation.CallerComponents.getValueIsAvailableSpecFor;
	...
	private TypeSpec buildCallerForCallHandlerCase(final ExecutableElement e) {
		...
		new Caller {
			...
			public void shouldCallMethod(TypedArray attrs) {
				// Variable implementation, generated by CallerComponents class
			}
		}
		 */
