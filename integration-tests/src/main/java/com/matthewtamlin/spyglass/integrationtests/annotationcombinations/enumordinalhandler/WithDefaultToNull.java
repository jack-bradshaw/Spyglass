...
package com.matthewtamlin.spyglass.integrationtests.annotationcombinations.enumordinalhandler;
...
public class WithDefaultToNull extends EnumOrdinalHandlerTestTargetBase {
  ...
  private void init(final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
    WithDefaultToNull_SpyglassCompanion
        ...
        .setStyleableResource(R.styleable.EnumOrdinalHandlerTestTargetBase)
