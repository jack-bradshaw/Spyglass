...
import com.matthewtamlin.spyglass.integrationtests.reactivex.flowable.WithConditionalHandler;
import com.matthewtamlin.spyglass.integrationtests.reactivex.flowable.WithUnconditionalHandlerAndDefault;
import com.matthewtamlin.spyglass.integrationtests.reactivex.flowable.WithUnconditionalHandlerAndNoDefault;
...
public class TestFlowable {
  ...
  public void testSubscriptionOccurs_conditionalHandler_attributeMissing() {
    final AttributeSet attrs = AttributeSetSupplier.fromXml(context, R.xml.flowable_without_attr);
  ...
  public void testSubscriptionOccurs_conditionalHandler_attributePresent() {
    final AttributeSet attrs = AttributeSetSupplier.fromXml(context, R.xml.flowable_with_attr_equals_true);
