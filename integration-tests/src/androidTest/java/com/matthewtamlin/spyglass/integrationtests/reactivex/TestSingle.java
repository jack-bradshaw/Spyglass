...
import com.matthewtamlin.spyglass.integrationtests.reactivex.single.WithConditionalHandler;
import com.matthewtamlin.spyglass.integrationtests.reactivex.single.WithUnconditionalHandlerAndDefault;
import com.matthewtamlin.spyglass.integrationtests.reactivex.single.WithUnconditionalHandlerAndNoDefault;
...
public class TestSingle {
  ...
  public void testSubscriptionOccurs_conditionalHandler_attributeMissing() {
    final AttributeSet attrs = AttributeSetSupplier.fromXml(context, R.xml.single_without_attr);
  ...
  public void testSubscriptionOccurs_conditionalHandler_attributePresent() {
    final AttributeSet attrs = AttributeSetSupplier.fromXml(context, R.xml.single_with_attr_equals_true);
