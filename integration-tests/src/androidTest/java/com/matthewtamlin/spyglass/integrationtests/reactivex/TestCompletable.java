...
import com.matthewtamlin.spyglass.integrationtests.reactivex.completable.WithConditionalHandler;
import com.matthewtamlin.spyglass.integrationtests.reactivex.completable.WithUnconditionalHandlerAndDefault;
import com.matthewtamlin.spyglass.integrationtests.reactivex.completable.WithUnconditionalHandlerAndNoDefault;
...
public class TestCompletable {
  ...
  public void testSubscriptionOccurs_conditionalHandler_attributeMissing() {
    final AttributeSet attrs = AttributeSetSupplier.fromXml(context, R.xml.completable_without_attr);
  ...
  public void testSubscriptionOccurs_conditionalHandler_attributePresent() {
    final AttributeSet attrs = AttributeSetSupplier.fromXml(context, R.xml.completable_with_attr_equals_true);
