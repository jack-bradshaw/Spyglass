...
import com.matthewtamlin.spyglass.integrationtests.reactivex.observable.WithConditionalHandler;
import com.matthewtamlin.spyglass.integrationtests.reactivex.observable.WithUnconditionalHandlerAndDefault;
import com.matthewtamlin.spyglass.integrationtests.reactivex.observable.WithUnconditionalHandlerAndNoDefault;
...
public class TestObservable {
  ...
  public void testSubscriptionOccurs_conditionalHandler_attributeMissing() {
    final AttributeSet attrs = AttributeSetSupplier.fromXml(context, R.xml.observable_without_attr);
  ...
  public void testSubscriptionOccurs_conditionalHandler_attributePresent() {
    final AttributeSet attrs = AttributeSetSupplier.fromXml(context, R.xml.observable_with_attr_equals_true);
