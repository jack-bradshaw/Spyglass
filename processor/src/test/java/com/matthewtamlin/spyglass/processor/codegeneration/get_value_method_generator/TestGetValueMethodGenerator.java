...
package com.matthewtamlin.spyglass.processor.codegeneration.get_value_method_generator;
...
public class TestGetValueMethodGenerator {
  ...
  public void testGenerateFor_enumConstantHandlerAnnotationSupplied() {
    ...
    checkSignature(generatedMethod, ClassName.get(Data.PlaceholderEnum.class));
    checkCompiles(generatedMethod);
  }
