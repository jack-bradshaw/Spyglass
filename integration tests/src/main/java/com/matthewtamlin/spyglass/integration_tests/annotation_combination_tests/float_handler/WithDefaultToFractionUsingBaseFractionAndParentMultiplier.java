package com.matthewtamlin.spyglass.integration_tests.annotation_combination_tests.float_handler;
...
public class WithDefaultToFractionUsingBaseFractionAndParentMultiplier extends FloatHandlerTestTargetBase {
	...
	public WithDefaultToFractionUsingBaseFractionAndParentMultiplier(final Context context, final AttributeSet attrs, final int defStyleAttr) {
	...
	private void init(final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
		Spyglass.builder()
				.withTarget(this)
				.withAnnotationSource(WithDefaultToFractionUsingBaseFractionAndParentMultiplier.class)
