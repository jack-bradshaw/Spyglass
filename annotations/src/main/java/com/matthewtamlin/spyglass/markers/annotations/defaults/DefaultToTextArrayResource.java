 ...
 * <li>The method has at least one {@code CharSequence} array parameter.</li>
 * <li>Except for one {@code CharSequence} array parameter, every parameter belonging to the method has a use
 * annotation.</li>
 * </ul>
 */
