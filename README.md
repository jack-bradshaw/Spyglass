...
dependencies {
	...
	compileOnly 'com.matthew-tamlin:spyglass-annotations:2.0.0'
	annotationProcessor 'com.matthew-tamlin:spyglass-processor:2.0.0'

	// For older projects:
	provided 'com.matthew-tamlin:spyglass-annotations:2.0.0'
	annotationProcessor 'com.matthew-tamlin:spyglass-processor:2.0.0'
}
```
