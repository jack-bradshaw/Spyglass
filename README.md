...
dependencies {
	...
	compileOnly 'com.matthew-tamlin:spyglass-annotations:1.1.0'
	annotationProcessor 'com.matthew-tamlin:spyglass-processor:1.1.0'

	// For older projects:
	provided 'com.matthew-tamlin:spyglass-annotations:1.1.0'
	annotationProcessor 'com.matthew-tamlin:spyglass-processor:1.1.0'
}
```
