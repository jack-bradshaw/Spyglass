 ...
 * methods which accept a Drawable and have a handler annotation, and it should not be used in
...
public @interface DefaultToDrawableResource {
	/**
	 * @return the resource ID of the default value, must resolve to a drawable
	 */
	int value();
}